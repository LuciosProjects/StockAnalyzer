...
class Company:
    def __init__(self, symbol: str, start_date: str) -> None:
        ...
        self.availableShares    = self.shares_outstanding # Initialy, the number of available shares are the total amount of shares for each ticker

        self.fundamental_influence = 0
        self.technical_influence   = 0
